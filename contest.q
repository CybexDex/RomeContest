...
reconnect:{[] hbase::hopen `$":210.3.74.58:6020:uatuser:u@T$Yb";hrdb::hopen `$":210.3.74.58:6036:uatuser:u@T$Yb";hhdb::hopen `$":210.3.74.58:6037:uatuser:u@T$Yb";hapi::hopen `$":210.3.74.58:6039:uatuser:u@T$Yb"}
closeconn:{[] hclose hbase; hclose hrdb; hclose hhdb; hclose hapi;}
...
getPortfolio:{[acct;slot] select [100] from `time xdesc  portfolio where (account = `$acct) and ( ((floor ( 1e-09*((time - (min time) )%01:00:00) )) mod slot ) =0)}
